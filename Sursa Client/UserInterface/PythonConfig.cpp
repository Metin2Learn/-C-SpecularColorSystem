...
std::string CPythonConfig::GetClassNameByType(EClassTypes eType) const
{
	...
	case CLASS_CHARACTER_SLOT:
		return "CHARACTER_SLOT";
		break;
	case CLASS_SPECULAR_COLOR_WEAPON:
		return "SPECULAR_COLOR_WEAPON";
		break;
	case CLASS_SPECULAR_COLOR_ARMOR:
		return "SPECULAR_COLOR_ARMOR";
		break;
	case CLASS_SPECULAR_COLOR_HAIR:
		return "SPECULAR_COLOR_HAIR";
		break;
#endif
	}
