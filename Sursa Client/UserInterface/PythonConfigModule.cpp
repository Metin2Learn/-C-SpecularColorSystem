...
void initcfg()
{
	...
	PyModule_AddIntConstant(poModule, "SAVE_CHARACTER_SLOT", CPythonConfig::CLASS_CHARACTER_SLOT);
	PyModule_AddIntConstant(poModule, "SAVE_SPECULAR_COLOR_WEAPON", CPythonConfig::CLASS_SPECULAR_COLOR_WEAPON);
	PyModule_AddIntConstant(poModule, "SAVE_SPECULAR_COLOR_ARMOR", CPythonConfig::CLASS_SPECULAR_COLOR_ARMOR);
	PyModule_AddIntConstant(poModule, "SAVE_SPECULAR_COLOR_HAIR", CPythonConfig::CLASS_SPECULAR_COLOR_HAIR);
#endif															   
}
